...
<body>
<main class="max-w-7xl mx-auto p-4 sm:p-6 bg-gray-50 dark:bg-gray-800 min-h-screen">
    ...
    <div class="bg-white dark:bg-gray-700 shadow-lg rounded-lg p-4 sm:p-8">
        ...
        <div class="mt-6 flex justify-end">
            <a href="{{ route('itineraries.create') }}" class="relative inline-block px-4 py-2 font-medium group"
