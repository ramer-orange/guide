                                ...
                                @if(!empty($plan['existing_planFiles']))
                                    <div class="mt-4 space-y-4">
                                        @foreach($plan['existing_planFiles'] as $existingFileIndex => $existingFile)
                                            <div
                                                class="flex items-center justify-between p-3 px-4 bg-gray-100 rounded-md shadow-sm">
                                                <!-- ファイル情報 -->
                                    ...
                                    @foreach($plan['planFiles'] as $fileIndex => $planFile)
                                        <div class="flex items-center">
                                            ...
                                            <label
                                                ...
                                                class="flex-1 px-4 py-2 border border-gray-300 rounded-md shadow-sm cursor-pointer focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
