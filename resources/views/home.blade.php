    ...
    <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
        ...
        <div
            ...
            <ul class="list-reset lg:flex justify-end flex-1 items-center">
                <li class="mr-3">
                    <a class="inline-block py-2 px-4 text-black font-bold no-underline" href="{{ route('home') }}">ホーム</a>
                </li>
                <li class="mr-3">
                    <a class="inline-block text-black no-underline hover:text-gray-800 hover:text-underline py-2 px-4"
                       href="{{ route('itineraries.create') }}">しおりを作る</a>
                </li>
                <li class="mr-3">
                    <a class="inline-block text-black no-underline hover:text-gray-800 hover:text-underline py-2 px-4"
                       href="{{ route('itineraries.index') }}">マイページ</a>
                </li>
            </ul>
            <button
                id="navAction"
        ...
        <div class="flex flex-wrap">
            <div class="w-5/6 sm:w-1/2 p-6">
                ...
                <p class="text-gray-600 mb-8">
                    理想の旅をデザインするしおり作成ツールで、準備の時間も楽しみに。
                </p>
            </div>
        ...
        <div class="flex flex-wrap flex-col-reverse sm:flex-row">
            ...
            <div class="w-full sm:w-1/2 p-6 mt-6">
                <div class="align-middle">
                    ...
                    <p class="text-gray-600 mb-8">
                        日程・持ち物・お土産リストまで、全て一箇所で管理できるしおり作成ツール。
                    </p>
                </div>
            </div>
        </div>
